...
Is't the final project for our mobile development course.
The app has a login page, a map, a weather pageand a server.

The login - Sign in page, new users can create a new account.

The map - The user can pick a place and save it in any name, it is also possible to chose from the past places he saved.
